...
os.environ["REPLICATE_API_TOKEN"]="59daa7de1955e2627b473c23c3c3fded75745ea0"
...
def index():
    if request.method == "POST":
        ...
        return(render_template("index.html.html",result=out[0]))
    else:
        return(render_template("index.html.html",result="waiting"))
